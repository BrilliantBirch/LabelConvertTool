...
def parser():
    ...
    parser.add_argument('--yoloLabels',type=str,default=r'E:\OCRSceneImage\prelabel\yololabels',help='Directory of yolo to be converted')
    parser.add_argument('--imageFolder',type=str,default=r'E:\OCRSceneImage\9000imgs',help='Image set')
    parser.add_argument('--predefinedClass',type=str,default=r'D:\labelme\labels.txt',help='Predefined classes text files')
    parser.add_argument('--outputdir',type=str,default=r'E:\OCRSceneImage\prelabel\labelme',help='labelme json output dir')
    parser.add_argument('--ppocrLabels',type=str,default=r'E:\OCRSceneImage\prelabel\ppocrlabel\system_results.txt',help='Directory of ppocr to be converted')
